...
const ChatInterface = () => {
  return (
    <div className="relative flex flex-col items-start px-10 mt-2.5 w-full text-white rounded-2xl h-[735px] max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex absolute bottom-3.5 z-0 flex-col items-center max-w-full text-base right-[219px] text-zinc-400 w-[766px]">
        <div className="flex overflow-hidden flex-col px-5 pt-5 pb-3 w-full rounded-3xl bg-white/20 backdrop-blur-md shadow-[0px_1px_30px_rgba(69,42,124,0.1)] max-md:max-w-full">
          <input
            type="text"
            placeholder="Type something..."
            className="self-start bg-transparent border-none outline-none w-full text-white placeholder:text-white/50"
          />
          <img
