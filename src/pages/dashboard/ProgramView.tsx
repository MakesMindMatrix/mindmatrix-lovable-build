    ...
    <Desktop activeTab="programs">
      <div className="flex w-full h-[calc(100vh-72px)] gap-6">
        ...
        <div className="w-2/4">
          <ScrollArea className="h-full">
            <div className="pr-4 pb-4">
              <h2 className="text-2xl font-semibold mb-6">Program Content</h2>
              <p className="text-gray-600 mb-4">
                Here you can find all the modules and materials for the Advanced Engineering Concepts program.
              </p>
              
              {/* Placeholder content - this would be replaced with actual program content */}
              <div className="space-y-4">
                {Array.from({length: 5}).map((_, i) => (
                  <Card key={i} className="border border-gray-200">
                    <CardContent className="p-4">
                      <h3 className="font-medium">Module {i + 1}</h3>
                      <p className="text-sm text-gray-500">
                        Module description and learning objectives would go here.
                      </p>
                    </CardContent>
                  </Card>
                ))}
