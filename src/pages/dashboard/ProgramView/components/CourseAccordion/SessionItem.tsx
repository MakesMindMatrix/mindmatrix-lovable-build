...
const SessionItem: React.FC<SessionItemProps> = ({
  ...
  return (
    <div
      ...
      className="mx-3 rounded-lg overflow-hidden bg-gray-300 shadow-sm"
    >
      <div
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h4 className="text-blue-600 text-xl font-medium">Session {session.id}</h4>
        </div>
        <div>
        ...
        <div className="px-4 pb-4">
          {session.components.map((component) => (
            <div 
              ...
              className={`
                py-3 px-4 text-blue-600 font-medium text-lg cursor-pointer
                ${component.id === 'tutorial' ? 'bg-blue-500 text-white' : ''}
              `}
            >
              {component.title}
            </div>
