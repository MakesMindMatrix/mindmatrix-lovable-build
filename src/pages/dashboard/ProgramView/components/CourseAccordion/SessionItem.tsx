  ...
  return (
    <div
      ...
      className={cn(
        ...
        isExpanded 
          ? "bg-blue-500/20 backdrop-blur-md border border-blue-400/30" // Blue glass effect for expanded session
          : "bg-gray-300"
      )}
    >
      <div
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h4 className="text-blue-600 text-lg font-medium">Session {session.id}</h4>
        </div>
        <div>
          {isExpanded ? (
