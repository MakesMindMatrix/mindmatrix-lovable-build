      ...
      <div className="space-y-1.5">
        <div className="flex items-center gap-2 p-1.5 bg-white/5 hover:bg-white/10 transition-colors rounded border border-white/10 cursor-pointer">
          ...
          <div className="flex-1">
            <p className="text-xs text-white">Introduction to Python Basics</p>
            <p className="text-[10px] text-white/60">10 pages • Required</p>
          </div>
          <Button 
            size="sm" 
            variant="outline" 
        ...
        <div className="flex items-center gap-2 p-1.5 bg-white/5 hover:bg-white/10 transition-colors rounded border border-white/10 cursor-pointer">
          ...
          <div className="flex-1">
            <p className="text-xs text-white">Course Overview Slides</p>
            <p className="text-[10px] text-white/60">15 slides • Optional</p>
          </div>
          <Button 
            size="sm" 
            variant="outline" 
