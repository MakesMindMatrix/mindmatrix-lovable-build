    ...
    <aside className="text-base font-medium text-white min-w-60 w-[273px]">
      <div className="w-full">
        ...
        <div className="flex flex-col mt-5 w-full text-xs font-semibold">
          <div className="flex gap-2 items-start self-start text-base font-medium tracking-tight rotate-[4.5911985324664784e-10rad]">
            <img
              ...
              alt="Info icon"
            />
            <span className="rotate-[-4.5911985324664784e-10rad]">
        ...
        <div className="flex flex-col justify-center items-end p-5 mt-5 mb-6 w-full rounded-3xl shadow-[0px_1px_30px_rgba(69,42,124,0.1)] text-zinc-400">
          <input
            type="text"
