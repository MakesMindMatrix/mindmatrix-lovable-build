...
import SkillMomentumCard from '@/widgets/day2onwards_widgets/skill_momentum/SkillMomentumCard';

const SkillMomentumScreen = () => {
  const navigate = useNavigate();
  
  useEffect(() => {
    // Auto navigate to the next screen after 3 seconds
    const timer = setTimeout(() => {
      navigate('/engagement-summary');
    }, 3000);
      ...
      <div className="relative w-full max-w-5xl aspect-[16/9] rounded-3xl overflow-hidden bg-gradient-to-b from-blue-400/50 to-blue-700/50 backdrop-blur-md">
        ...
        <div className="flex flex-col items-center pt-12 text-white">
          ...
          <p className="text-center max-w-md mb-12">
            Here's your skill map! Focus on improving your weakest 
            areas to boost your confidence and competence.
          </p>
        </div>
...
export default SkillMomentumScreen;
